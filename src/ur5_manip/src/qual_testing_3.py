    ...
    while not rospy.is_shutdown(): 
        ...
        if (move_completed == 0):
            ...
            if (state == HOME): 
                ...
                ur5.set_speed(.1)
                start_pose = relative_pose(home_pose, .1, 0.03, -.13, 0, 3.14159/4, 0)
                ...
                ur5.set_speed(.05)
                pose_1 = relative_pose(start_pose, -.07, 0, 0, 0, 0, 0)
                ur5.goto_pose_target(pose_1, wait = False)
                move_completed = 1
            
            elif (state == MOVE_2):
                print("Performing second movement")
                pose_2 = relative_pose(pose_1, -.16, 0, .13, 0,-3.14159/4,0)
                ...
                ur5.set_speed(.1)
                pose_3 = relative_pose(pose_2, 0,0,.1,0,0,0)
                ...
                ur5.set_speed(.15)
                pose_4 = relative_pose(pose_3, 0, 0, 0, 0, 0, 0)
                ...
                ur5.set_speed(.05)
                pose_4 = relative_pose(pose_4, 0, 0, 0, 0, 0, 0)
                ur5.goto_pose_target(pose_4, wait=False)
                move_completed = 1
