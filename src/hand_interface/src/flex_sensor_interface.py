...
def get_calibration_values():
    ...
    low_vals = [600,415,410,445,495,444,600,355] 
    high_vals = [325,150,230,189,280,135,335,140] 
    
#    low_vals = [600,620,405,450,500,650,600,600] 
#    high_vals = [330,290,190,190,270,250,300,290] 
