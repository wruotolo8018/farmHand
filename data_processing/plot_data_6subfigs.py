...
fig, ((R0Plot, RSPlot, RLPlot), (C0Plot, CSPlot, CLPlot)) = plt.subplots(figsize=(20,10), nrows=2, ncols=3)
...
R0Plot.clear()
R0Plot.plot(dispR0, phal1DataR0, 'v', color='black')
R0Plot.plot(dispR0, phal2DataR0, '^', color='green')
...
RSPlot.clear()
RSPlot.plot(dispRS, phal1DataRS, 'v', color='black')
RSPlot.plot(dispRS, phal2DataRS, '^', color='green')
...
RLPlot.clear()
RLPlot.plot(dispRL, phal1DataRL, 'v', color='black')
RLPlot.plot(dispRL, phal2DataRL, '^', color='green')
...
# R0Plot.title.set_text('Degressive - Zero Offset')
# RSPlot.title.set_text('Degressive - Small Offset')
# RLPlot.title.set_text('Degressive - Large Offset')

R0Plot.title.set_text('Zero Offset')
RSPlot.title.set_text('Small Offset')
RLPlot.title.set_text('Large Offset')


C0Plot.clear()
C0Plot.plot(dispC0, phal1DataC0, 'v', color='black')
C0Plot.plot(dispC0, phal2DataC0, '^', color='tomato')
...
CSPlot.clear()
CSPlot.plot(dispCS, phal1DataCS, 'v', color='black')
CSPlot.plot(dispCS, phal2DataCS, '^', color='tomato')
...
CLPlot.clear()
CLPlot.plot(dispCL, phal1DataCL, 'v', color='black')
CLPlot.plot(dispCL, phal2DataCL, '^', color='tomato')
CLPlot.set_ylim(-0.5, 10.5)
# CLPlot.set_xlim(-0.5, 10.5)
CLPlot.set_xlabel('Displacement (cm)')
# CLPlot.set_ylabel('Force (N)')

# C0Plot.title.set_text('Linear - 0 Offset')
# CSPlot.title.set_text('Linear - Small Offset')
# CLPlot.title.set_text('Linear - Large Offset')
