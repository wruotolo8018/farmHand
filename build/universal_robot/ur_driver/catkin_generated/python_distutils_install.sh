...
echo_and_run cd "/home/wilson/farmHand_ws/src/universal_robot/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/wilson/farmHand_ws/src/universal_robot/ur_driver/setup.py" \
    build --build-base "/home/wilson/farmHand_ws/build/universal_robot/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
