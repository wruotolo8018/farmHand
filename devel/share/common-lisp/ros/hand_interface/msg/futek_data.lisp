...
(cl:defmethod cl:initialize-instance :after ((m <futek_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'futek_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hand_interface-msg:<futek_data> is deprecated: use hand_interface-msg:futek_data instead.")))

(cl:ensure-generic-function 'futek1-val :lambda-list '(m))
(cl:defmethod futek1-val ((m <futek_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_interface-msg:futek1-val is deprecated.  Use hand_interface-msg:futek1 instead.")
  (futek1 m))

(cl:ensure-generic-function 'futek2-val :lambda-list '(m))
(cl:defmethod futek2-val ((m <futek_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_interface-msg:futek2-val is deprecated.  Use hand_interface-msg:futek2 instead.")
  (futek2 m))
